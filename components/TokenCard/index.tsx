...
const TokenCard = ({ amount, onAmountChange, balance, price }: TokenCardProps) => {
  return (
    <View className="flex flex-col gap-2 bg-card border border-border rounded-twice p-6 md:p-10">
      ...
      <View className="flex-row justify-between items-center gap-4">
        ...
        <View className="flex flex-col flex-1 items-end">
          <TextInput
            ...
            className="w-full text-right text-2xl md:text-5xl font-semibold web:focus:outline-none"
            value={amount}
            placeholder="0"
