...
export default narrow([
  {
    inputs: [
      ...
      { internalType: "bool", name: "_trackWithdrawsOnChain", type: "bool" },
    ],
  ...
  {
    inputs: [],
    name: "BoringOnChainQueueWithTracking__ZeroNonce",
    type: "error",
  },
  ...
  { anonymous: false, inputs: [], name: "Paused", type: "event" },
  {
    ...
    name: "TrackWithdrawsOnChainToggled",
    type: "event",
  },
  ...
  },
  {
    ...
    name: "cancelOnChainWithdrawUsingRequestId",
    outputs: [
      {
        components: [
          { internalType: "uint96", name: "nonce", type: "uint96" },
  ...
  },
  {
    ...
    name: "replaceOnChainWithdrawUsingRequestId",
    outputs: [
      {
        components: [
          { internalType: "uint96", name: "nonce", type: "uint96" },
  ...
  {
    inputs: [],
    name: "toggleTrackWithdrawsOnChain",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
